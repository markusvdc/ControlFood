...
Todas as opções globais iniciam desativadas. Escolhas já salvas são preservadas, e novas opções adicionadas a configurações existentes também iniciam desativadas.
